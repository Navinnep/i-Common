...
class RestApiTests extends Specification {
    ...
    def cleanupSpec() {
        long totalTime = System.currentTimeMillis() - screenTest.i-CommonTime
    ...
    @Unroll
    def "call i-Common REST API (#requestMethod, #screenPath, #containsTextList)"() {
        expect:
        ...
        // Test i-Common Rest API here
        // "put" | "s1/i-Common/exampleendpoint" | [moquiSessionToken:token] | ['55800']
    }
}
